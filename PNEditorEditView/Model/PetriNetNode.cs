...
namespace PNEditorEditView
{
    ...
    public class PetriNetNode : Node
    {
        ...
        private int visited;
        private int toArcsCount;
        private int currentToArcsCount;
        ...
        public int ToArcsCount
        {
            get { return toArcsCount; }
            set
            {
                toArcsCount = value;
            }
        }
        public int CurrentToArcsCount
        {
            get { return currentToArcsCount; }
            set
            {
                currentToArcsCount = value;
            }
        }
        public List<int> PotentNeighbours = new List<int>();
        public List<string> PotentNeighboursID = new List<string>();
    ...
    public class VPlace : PetriNetNode
    {
        ...
        public VPlace Copy()
        {
            VPlace toCopy = new VPlace(CoordX, CoordY, NumberOfTokens, Id);
            toCopy.Label = Label;
            return toCopy;
        }
    ...
    public class VTransition : PetriNetNode
    {
        ...
        {
            VTransition toCopy = new VTransition(CoordX, CoordY, Id);
            toCopy.Label = Label;
            return toCopy;
        }
    }
